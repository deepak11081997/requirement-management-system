...
/**
 * Servlet implementation class UserSearchCount
 */
@WebServlet("/UserSearchCount")
public class UserSearchCount extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			s=d.findspecificcount(Uid,search,me);
