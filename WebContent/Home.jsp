...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <form id="signin" action="UserLoginCheck" method="post" class="navbar-form navbar-right" role="form">
...
<div class="container">
<h2>Requirement Management System</h2><br>
<img src="service.jpg"  height="400" width="600">
</div>
<%}else{ 
